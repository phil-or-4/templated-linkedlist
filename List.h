...
Author: Phillip Sopt
Description:
This is a .h file that contains the declarations and definitions of the functions that belong to the List class. The
type of list generated by the List class is a singly linked list. This class is a templated class so each node of 
the list can be whatever data type you want it to be. There's a host of functions to use with this class I will list
them below:
equal_to  
count  
length  
